        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nama_barang" value="Burger">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="harga_beli">Harga beli</label>
                    <input type="number" class="form-control" name="harga_beli" value="10000">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="harga_jual">Harga jual</label>
                    <input type="number" class="form-control" name="harga_jual" value="12000">
                </div>
                <div class="mb-3">
